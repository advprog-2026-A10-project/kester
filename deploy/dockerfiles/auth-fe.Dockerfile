...
COPY services/bidmart-auth-fe/package.json ./
COPY services/bidmart-auth-fe/pnpm-lock.yaml* services/bidmart-auth-fe/yarn.lock* services/bidmart-auth-fe/package-lock.json* ./
